...
if(isset($_POST['process'])){
    ...
    $pass= ''; 
    $db= 'portfolio';
    $connect= MYSQLI_CONNECT($host, $user, $pass, $db) or die('could not connect');
    ...
    $sql="INSERT INTO form (id, name, email, number, subject) VALUES ('', '$name','$email', '$number', '$subject')";
...
<body>
    ...
    <!--navigational bar (use some font awesome icons)-->
    <ul class="nav_bar">
        <div class="pics"></div>
    ...
    <!--container is a prent div for the whole movable part of the site-->
    <div class="container">
      ...
      <!--statistics-->
        <ul class="stats">
            <li><span style="font-size: 25px;">11+</span><br>Partners</li>
            <li><span style="font-size: 25px;">55+</span><br>Project Done</li>
            <li><span style="font-size: 25px;">89+</span><br>Happy Clients</li>
            <li><span style="font-size: 25px;">150+</span><br>Meetings</li>
        </ul>
    
        <button class="b1"><i class="fa-solid fa-cloud-arrow-down" style="margin-right: 10px;"></i>Download CV</button>


          <!--somethimg like plan or pricings-->
        <h2 style=" width:140px;
                    margin-left: 20px;
                    color: #fff;">
        Packages</h2> 
       ...
       <!-- <h2 style=" margin-left: 20px;
        ...
        <div class="gallery_grid" id="pics">
            ...
            <div class="img_9"><img src="images/img9.jpg" class="image-responsive resp9"></div>
        </div>
